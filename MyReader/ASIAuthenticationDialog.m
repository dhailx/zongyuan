...
+ (void)dismiss
{
    //[[sharedDialog parentViewController] dismissModalViewControllerAnimated:YES];//这个方法是原来的,现在的用下面的;
...
- (void)show
{
	...
	//[[self presentingController] presentModalViewController:self animated:YES];//原来是这一个方法,现在改成下面的那些
