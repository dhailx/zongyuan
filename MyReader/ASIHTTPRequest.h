...
typedef enum _ASINetworkErrorType {
    ASIConnectionFailureErrorType = 1,//连接失败
    ASIRequestTimedOutErrorType = 2,//请求超时
    ASIAuthenticationErrorType = 3,//认证错误
    ASIRequestCancelledErrorType = 4,//请求取消错误
    ASIUnableToCreateRequestErrorType = 5,//无法创建请求
    ASIInternalErrorWhileBuildingRequestType  = 6,//内部错误,同时建立请求类型
    ASIInternalErrorWhileApplyingCredentialsType  = 7,//内部错误,同时应用凭据类型
	ASIFileManagementError = 8,//文件管理类型
	ASITooMuchRedirectionErrorType = 9,//太多重定向错误
	ASIUnhandledExceptionError = 10,//未处理的类型错误
	ASICompressionError = 11//压缩错误
